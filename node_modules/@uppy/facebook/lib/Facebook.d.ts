...
export default class Facebook<M extends Meta, B extends Body> extends UIPlugin<FacebookOptions, M, B, UnknownProviderPluginState> implements UnknownProviderPlugin<M, B> {
