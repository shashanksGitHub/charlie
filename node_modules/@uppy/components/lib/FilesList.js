...
export default function FilesList(props) {
    ...
    return (_jsx("ul", { "data-uppy-element": "files-list", className: "uppy-reset uppy:my-4", children: files?.map((file) => (_jsx("li", { children: _jsxs(Fragment, { children: [_jsxs("div", { className: "uppy:flex uppy:items-center uppy:gap-2", children: [_jsx("div", { className: "uppy:w-[32px] uppy:h-[32px]", children: _jsx(Thumbnail, { width: "32px", height: "32px", file: file }) }), _jsx("p", { className: "uppy:truncate", children: file.name }), _jsx("p", { className: "uppy:text-gray-500 uppy:tabular-nums uppy:min-w-18 uppy:text-right uppy:ml-auto", children: prettyBytes(file.size || 0) }), _jsxs(Fragment, { children: [editFile && (_jsx("button", { type: "button", className: "uppy:flex uppy:rounded uppy:text-blue-500 uppy:hover:text-blue-700 uppy:bg-transparent uppy:transition-colors", onClick: () => {
                                            editFile(file);
